...
CREATE TABLE `tbl_settings` (
  ...
  `contact_email` varchar(155) NOT NULL,
  `contact_phone` varchar(155) NOT NULL,
  `contact_fax` varchar(155) NOT NULL,
  `contact_map_iframe` text NOT NULL,
  `receive_email` varchar(155) NOT NULL,
  `receive_email_subject` varchar(155) NOT NULL,
  `receive_email_thank_you_message` text NOT NULL,
  `forget_password_message` text NOT NULL,
  `total_recent_post_footer` int(10) NOT NULL,
  `total_popular_post_footer` int(10) NOT NULL,
  `total_recent_post_sidebar` int(8) NOT NULL,
  `total_popular_post_sidebar` int(8) NOT NULL,
  `total_featured_product_home` int(8) NOT NULL,
  `total_latest_product_home` int(8) NOT NULL,
  `total_popular_product_home` int(8) NOT NULL,
  `meta_title_home` text NOT NULL,
  `meta_keyword_home` text NOT NULL,
  `meta_description_home` text NOT NULL,
  `banner_login` varchar(155) NOT NULL,
  `banner_registration` varchar(155) NOT NULL,
  `banner_forget_password` varchar(155) NOT NULL,
  `banner_reset_password` varchar(155) NOT NULL,
  `banner_search` varchar(155) NOT NULL,
  `banner_cart` varchar(155) NOT NULL,
  `banner_checkout` varchar(155) NOT NULL,
  `banner_product_category` varchar(155) NOT NULL,
  `banner_blog` varchar(155) NOT NULL,
  `cta_title` varchar(155) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` varchar(155) NOT NULL,
  `cta_read_more_url` varchar(155) NOT NULL,
  `cta_photo` varchar(155) NOT NULL,
  `featured_product_title` varchar(155) NOT NULL,
  `featured_product_subtitle` varchar(155) NOT NULL,
  `latest_product_title` varchar(155) NOT NULL,
  `latest_product_subtitle` varchar(155) NOT NULL,
  `popular_product_title` varchar(155) NOT NULL,
  `popular_product_subtitle` varchar(155) NOT NULL,
  `testimonial_title` varchar(155) NOT NULL,
  `testimonial_subtitle` varchar(155) NOT NULL,
  `testimonial_photo` varchar(155) NOT NULL,
  `blog_title` varchar(155) NOT NULL,
  `blog_subtitle` varchar(155) NOT NULL,
  `newsletter_text` text NOT NULL,
  `paypal_email` varchar(155) NOT NULL,
  `stripe_public_key` varchar(155) NOT NULL,
  `stripe_secret_key` varchar(155) NOT NULL,
  `bank_detail` text NOT NULL,
  `before_head` text NOT NULL,
  `after_body` text NOT NULL,
  `before_body` text NOT NULL,
  `home_service_on_off` int(8) NOT NULL,
  `home_welcome_on_off` int(8) NOT NULL,
  `home_featured_product_on_off` int(8) NOT NULL,
  `home_latest_product_on_off` int(8) NOT NULL,
  `home_popular_product_on_off` int(8) NOT NULL,
  `home_testimonial_on_off` int(8) NOT NULL,
  `home_blog_on_off` int(8) NOT NULL,
  `newsletter_on_off` int(8) NOT NULL,
